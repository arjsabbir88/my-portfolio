...
const TwitterCard = () => {
  return (
    <div className="relative w-[100px] h-[100px] rounded-3xl overflow-hidden border-2 border-white shadow-[0_7px_29px_0px_rgba(237,178,78,0.4)] transition-all duration-1000 hover:scale-110 group animate-[bounce-custom_2s_infinite]">
      ...
      {/* gradient-to-tr from-[#1da1f2] via-[#60c0f8] to-[#1da1f2] */}
      ...
      <Link to="https://twitter.com/arjsabbir88" target="_blank" rel="noopener noreferrer">
        ...
        {/* before:bg-[radial-gradient(circle_at_30%_107%,#91e9ff_0%,#00ACEE_90%)] */}
          <span className="inline-block w-5 h-5">
            <FaTwitter className="w-full h-full text-white/80 group-hover:drop-shadow-[0_0_5px_white] transition-all duration-500" />
          </span>
